...
public class AiOrchestrationService {
    ...
    private static final String PROTEIN_CALCULATION_PROMPT = """
            ...
            The format used for the response should be in html to be display on a website. It should human readable.
            ...
            2. Get the food code for each of the food item. If you find more than one result for a given food item, just keep the most relevant one. Do not retry to find food item if you had multiple choices. However, if you cannot find it once, please try again at least two more time;
